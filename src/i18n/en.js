const en = {
  ...
  ssoCredentials: 'SSO Auto-Login',
  ssoUsernameLabel: 'USTC ID / GID',
  ssoPasswordLabel: 'Password',
  ssoCredentialsSaved: 'Credentials saved (encrypted)',
  ssoCredentialsCleared: 'Credentials cleared',
